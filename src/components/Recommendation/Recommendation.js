...
import { Container, Message, Text, List } from '../UI';
...
export default class Recommendation extends PureComponent {
    ...
    refreshHandler = () => {
        this.setState({ refreshing: true }, () => this.getRecommendations());
    };

    render () {
        const { recommendation } = this.props;
        const { fetch, failure, successful, payload, refreshing } = this.state;
