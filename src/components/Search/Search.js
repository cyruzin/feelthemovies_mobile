...
export default class Search extends PureComponent {
    ...
    loadMoreHandler = async () => {
        const { payload, currentPage, textInput } = this.state
    ...
    textInputHandler = (textInput) => {
        this.setState({ textInput: textInput.trim() })
    ...
    render() {
        ...
        return (
            <Container style={styles.container}>
                ...
                {successful && payload.length === 0 && <Message text="No Result" />}

                {!successful && !warning && failure !== '' && <Message text={failure} />}
                ...
                {successful
                    ? (
                        <View style={styles.searchResultsBox}>
                            ...
                            {screenPosition >= 250 && <ScrollTop onPress={this.scrollTopHandler} />}
